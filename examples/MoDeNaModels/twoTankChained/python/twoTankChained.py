...
class TwoTankChainedModel(BackwardMappingScriptTask):
    """Macroscopic two-tank chained simulation task."""

    _fw_name = '{{twoTankChained.TwoTankChainedModel}}'
