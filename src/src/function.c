...
/*
// Fill the buffer with a null terminated string in encoding
void UnicodeObj_To_BytesStr(PyObject * obj, char * str)
{
    PyObject * bytes_obj = PyUnicode_AsEncodedString(obj, "UTF-8", "strict"); // Owned reference
    if (PyUnicode_Check(obj)) {
        // Convert string to bytes.
        str = strdup(bytes_obj);
        Py_DECREF(bytes_obj);
...
void modena_function_load_library(modena_function_t* self)
{
    ...
    self->function = lt_dlsym(self->handle, PyBytes_AsString(pFuncBytes));
...
PyTypeObject modena_function_tType = {
    ...
    .tp_name           = "modena.modena_function_t",
    .tp_basicsize      = sizeof(modena_function_t),
    .tp_itemsize       = 0,
    .tp_dealloc        = (destructor)modena_function_t_dealloc,
    .tp_getattr        = 0,
    .tp_setattr        = 0,
    .tp_repr           = 0,
    .tp_as_number      = 0,
    ...
    .tp_iter           = 0,
    .tp_iternext       = 0,
    .tp_methods        = modena_function_t_methods,
    .tp_members        = modena_function_t_members,
    .tp_getset         = 0,
    .tp_base           = 0,
    .tp_dict           = 0,
    .tp_descr_get      = 0,
    .tp_descr_set      = 0,
    .tp_dictoffset     = 0,
    .tp_init           = (initproc)modena_function_t_init,
    .tp_alloc          = 0,
    .tp_new            = modena_function_t_new,
    .tp_as_async       = 0,
};
